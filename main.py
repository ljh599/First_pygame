...
pygame.display.set_caption("新試劑服英戰士")
clock = pygame.time.Clock()

#載入圖片
background_img = pygame.image.load(os.path.join("img", "impact.jpg")).convert()
background_img = pygame.transform.scale(background_img,(WIDTH, HIGHT + 20))
player_img = pygame.image.load(os.path.join("img", "tai.png")).convert()
player_mini_img = pygame.transform.scale(player_img,(30, 25))
player_mini_img.set_colorkey(WHITE)
pygame.display.set_icon(player_mini_img)
rock_img = pygame.image.load(os.path.join("img", "taiwan.png")).convert()
bullet_img = pygame.image.load(os.path.join("img", "niddle.png")).convert()
expl_anim = {}
expl_anim['lg'] = []
expl_anim['sm'] = []
expl_anim['player'] = []
...
miss_sound = pygame.mixer.Sound(os.path.join("sound", "miss.mp3"))
pygame.mixer.music.load(os.path.join("sound", "background.mp3"))

#字體
font_name = os.path.join("SoukouMincho.ttf")
...
def draw_init():
    ...
    draw_text(screen, "新試劑服英戰士", 64, WIDTH / 2, HIGHT / 4, GREEN)
    draw_text(screen, "← →移動飛船 空白鍵發射子彈", 22, WIDTH / 2, HIGHT / 2, WHITE)
    draw_text(screen, "任意鍵開始遊戲", 22,WIDTH / 2, HIGHT*3 / 4, WHITE)
...
class Rock(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image_ori = pygame.transform.scale(rock_img, (120, 80))
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(bullet_img, (80, 80))
    ...
    def update(self):
          ...
          if now - self.last_update > self.frame_rate:
              ...
              if self.frame == len(expl_anim[self.size]):
                  ...
                  self.image = expl_anim[expl.size][expl.frame]
                  center = self.rect.center
                  self.rect = self.image.get_rect()
                  self.rect.center = center
...
while running:
    ...
    draw_text(screen, '台灣價值:  ' + str(score), 18, WIDTH / 2, 10, GREEN)
